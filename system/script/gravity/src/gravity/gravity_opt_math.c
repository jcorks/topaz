...
static bool math_abs (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool math_acos (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_asin (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_atan (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_atan2 (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm)
...
static bool math_cbrt (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_xrt (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs != 3) RETURN_VALUE(VALUE_FROM_UNDEFINED, rindex);
...
static bool math_ceil (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_cos (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_exp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_floor (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_gcf (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool math_lcm (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (vm, rindex)
...
static bool math_lerp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
#pragma unused(vm, nargs)
...
static bool math_log (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_log10 (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_logx (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t base = GET_VALUE(1);
    gravity_value_t value = GET_VALUE(2);
...
static bool math_max (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool math_min (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs == 1) RETURN_VALUE(VALUE_FROM_NULL, rindex);
...
static bool math_pow (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm)
...
static bool math_round (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_sin (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_sqrt (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
static bool math_tan (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_value_t value = GET_VALUE(1);
...
// CONSTANTS
static bool math_PI (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(3.141592653589793), rindex);
}

static bool math_E (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(2.718281828459045), rindex);
}

static bool math_LN2 (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(0.6931471805599453), rindex);
}

static bool math_LN10 (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(2.302585092994046), rindex);
}

static bool math_LOG2E (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(1.4426950408889634), rindex);
}

static bool math_LOG10E (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(0.4342944819032518), rindex);
}

static bool math_SQRT2 (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(1.4142135623730951), rindex);
}

static bool math_SQRT1_2 (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
...
static bool math_random (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm)
