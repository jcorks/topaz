...
typedef bool (*gravity_c_internal)(gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * userData);
...
typedef struct {
    ...
    union {
        ...
        struct {
            ...
            void *              internalData;   // function callback data
        };
...
GRAVITY_API gravity_list_t      *gravity_list_deserialize (gravity_vm *vm, json_value *entry);
