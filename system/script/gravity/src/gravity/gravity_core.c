...
static bool convert_object_int (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool convert_object_float (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool convert_object_bool (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool convert_object_string (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool object_class (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_class_t *c = gravity_value_getclass(GET_VALUE(0));
    RETURN_VALUE(VALUE_FROM_OBJECT(c), rindex);
}

static bool object_meta (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_class_t *c = gravity_value_getclass(GET_VALUE(0));
    RETURN_VALUE(VALUE_FROM_OBJECT(gravity_class_get_meta(c)), rindex);
}

static bool object_respond (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_class_t *c = gravity_value_getclass(GET_VALUE(0));
...
static bool object_properties (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return object_real_introspection(vm, args, nargs, rindex, introspection_info_variables);
}

static bool object_introspection (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return object_real_introspection(vm, args, nargs, rindex, introspection_info_all);
}

// MARK: - Object Class -

static bool object_internal_size (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool object_is (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool object_eqq (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool object_neqq (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    object_eqq(vm, args, nargs, rindex, NULL);
...
static bool object_cmp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool object_not (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    // !obj
...
static bool object_load (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool object_store (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool object_notfound (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool object_bind (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool object_unbind (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(rindex)
...
static bool object_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_ERROR("Forbidden Object execution.");
}

static bool object_clone (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool list_count (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
    RETURN_VALUE(VALUE_FROM_INT(marray_size(list->array)), rindex);
}

static bool list_contains (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
...
static bool list_indexOf (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
    gravity_value_t element = GET_VALUE(1);
...
static bool list_loadat (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_list_t    *list = VALUE_AS_LIST(GET_VALUE(0));
...
static bool list_storeat (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs, rindex)
    gravity_list_t    *list = VALUE_AS_LIST(GET_VALUE(0));
...
static bool list_push (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
    gravity_value_t value = GET_VALUE(1);
...
static bool list_pop (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
    gravity_list_t    *list = VALUE_AS_LIST(GET_VALUE(0));
...
static bool list_remove (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
...
static bool list_iterator (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
...
static bool list_iterator_next (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
...
static bool list_loop (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs < 2) RETURN_ERROR("Incorrect number of arguments.");
...
static bool list_reverse (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool list_reversed (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs > 1) RETURN_ERROR("Incorrect number of arguments.");
...
static bool list_sort (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool list_sorted (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    //the predicate is the comparison function passed to list.sort() if any
    gravity_closure_t *predicate = NULL;
    list_comparison_callback *callback = NULL;
    if (nargs >=2 && VALUE_ISA_CLOSURE(GET_VALUE(1))) predicate = VALUE_AS_CLOSURE(GET_VALUE(1));
...
static bool list_map (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool list_filter (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool list_reduce (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool list_join (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    gravity_list_t *list = VALUE_AS_LIST(GET_VALUE(0));
    const char *sep = NULL;
...
static bool list_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool map_count (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_map_t *map = VALUE_AS_MAP(GET_VALUE(0));
    RETURN_VALUE(VALUE_FROM_INT(gravity_hash_count(map->hash)), rindex);
}

static bool map_keys (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
    gravity_map_t *map = VALUE_AS_MAP(GET_VALUE(0));
    uint32_t count = gravity_hash_count(map->hash);
...
static bool map_load (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool map_loadat (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool map_haskey (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_map_t *map = VALUE_AS_MAP(GET_VALUE(0));
    gravity_value_t key = GET_VALUE(1);
...
static bool map_storeat (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs, rindex)
    gravity_map_t *map = VALUE_AS_MAP(GET_VALUE(0));
    gravity_value_t key = GET_VALUE(1);
    gravity_value_t value = GET_VALUE(2);
...
static bool map_remove (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_map_t *map = VALUE_AS_MAP(GET_VALUE(0));
    gravity_value_t key = GET_VALUE(1);
...
static bool map_loop (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs < 2) RETURN_ERROR("Incorrect number of arguments.");
    if (!VALUE_ISA_CLOSURE(GET_VALUE(1))) RETURN_ERROR("Argument must be a Closure.");
...
static bool map_iterator (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
...
static bool range_count (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool range_from (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool range_to (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool range_loop (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs < 2) RETURN_ERROR("Incorrect number of arguments.");
    if (!VALUE_ISA_CLOSURE(GET_VALUE(1))) RETURN_ERROR("Argument must be a Closure.");
...
static bool range_iterator (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_range_t *range = VALUE_AS_RANGE(GET_VALUE(0));
...
static bool range_iterator_next (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    RETURN_VALUE(GET_VALUE(1), rindex);
}

static bool range_contains (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_range_t *range = VALUE_AS_RANGE(GET_VALUE(0));
    gravity_value_t value = GET_VALUE(1);
...
static bool range_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool class_name (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_class_t *c = (GET_VALUE(0).p);
    RETURN_VALUE(VALUE_FROM_CSTRING(vm, c->identifier), rindex);
}

static bool class_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool closure_disassemble (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool closure_apply (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool closure_bind (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool function_closure (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool function_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool operator_float_add (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_float_sub (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_float_div (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_float_mul (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_float_rem (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_float_and (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_float_or (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_float_neg (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(-GET_VALUE(0).f), rindex);
}

static bool operator_float_not (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    RETURN_VALUE(VALUE_FROM_BOOL(!GET_VALUE(0).f), rindex);
}

static bool operator_float_cmp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool function_float_round (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool function_float_floor (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool function_float_ceil (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool float_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool float_degrees (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    // Convert the float from radians to degrees
    RETURN_VALUE(VALUE_FROM_FLOAT(GET_VALUE(0).f*180/3.141592653589793), rindex);
}

static bool float_radians (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    // Convert the float from degrees to radians
    RETURN_VALUE(VALUE_FROM_FLOAT(GET_VALUE(0).f*3.141592653589793/180.0), rindex);
}

static bool float_isclose (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool float_min (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FLOAT(GRAVITY_FLOAT_MIN), rindex);
}

static bool float_max (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
...
// binary operators
static bool operator_int_add (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs)
    DECLARE_2VARIABLES(v1, v2, 0, 1);
...
static bool operator_int_sub (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs)
    DECLARE_2VARIABLES(v1, v2, 0, 1);
    INTERNAL_CONVERT_INT(v2, true);
    RETURN_VALUE(VALUE_FROM_INT(v1.n - v2.n), rindex);
...
static bool operator_int_div (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs)
    DECLARE_2VARIABLES(v1, v2, 0, 1);
    INTERNAL_CONVERT_INT(v2, true);
...
static bool operator_int_mul (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs)
    DECLARE_2VARIABLES(v1, v2, 0, 1);
    INTERNAL_CONVERT_INT(v2, true);
    RETURN_VALUE(VALUE_FROM_INT(v1.n * v2.n), rindex);
...
static bool operator_int_rem (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs)
    DECLARE_2VARIABLES(v1, v2, 0, 1);
    INTERNAL_CONVERT_INT(v2, true);
...
static bool operator_int_and (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs)
    DECLARE_2VARIABLES(v1, v2, 0, 1);
    INTERNAL_CONVERT_BOOL(v1, true);
    INTERNAL_CONVERT_BOOL(v2, true);
...
static bool operator_int_or (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs)
    DECLARE_2VARIABLES(v1, v2, 0, 1);
    INTERNAL_CONVERT_BOOL(v1, true);
    INTERNAL_CONVERT_BOOL(v2, true);
...
static bool operator_int_neg (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    RETURN_VALUE(VALUE_FROM_INT(-GET_VALUE(0).n), rindex);
}

static bool operator_int_not (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    RETURN_VALUE(VALUE_FROM_BOOL(!GET_VALUE(0).n), rindex);
}

static bool operator_int_cmp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (VALUE_ISA_FLOAT(args[1])) {
        ...
        return operator_float_cmp(vm, args, nargs, rindex, NULL);
    }
...
static bool int_loop (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs < 2) RETURN_ERROR("Incorrect number of arguments.");
    if (!VALUE_ISA_CLOSURE(GET_VALUE(1))) RETURN_ERROR("Argument must be a Closure.");
...
static bool int_random (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(args)
...
static bool int_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool int_degrees (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    // Convert the int from radians to degrees
    RETURN_VALUE(VALUE_FROM_FLOAT(GET_VALUE(0).n*180/3.141592653589793), rindex);
}

static bool int_radians (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    // Convert the int from degrees to radians
    RETURN_VALUE(VALUE_FROM_FLOAT(GET_VALUE(0).n*3.141592653589793/180), rindex);
}

static bool int_min (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_INT(GRAVITY_INT_MIN), rindex);
}

static bool int_max (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
...
static bool operator_bool_add (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return operator_int_add(vm, args, nargs, rindex, NULL);
}

static bool operator_bool_sub (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return operator_int_sub(vm, args, nargs, rindex, NULL);
}

static bool operator_bool_div (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return operator_int_div(vm, args, nargs, rindex, NULL);
}

static bool operator_bool_mul (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return operator_int_mul(vm, args, nargs, rindex, NULL);
}

static bool operator_bool_rem (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return operator_int_rem(vm, args, nargs, rindex, NULL);
}

static bool operator_bool_and (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_bool_or (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_bool_bitor (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_bool_bitand (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_bool_bitxor (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_bool_cmp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return operator_int_cmp(vm, args, nargs, rindex, NULL);
}

// unary operators
static bool operator_bool_neg (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    RETURN_VALUE(VALUE_FROM_INT(-GET_VALUE(0).n), rindex);
}

static bool operator_bool_not (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    RETURN_VALUE(VALUE_FROM_INT(!GET_VALUE(0).n), rindex);
}

static bool bool_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool operator_string_add (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_string_sub (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_string_and (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_string_or (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_string_neg (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool operator_string_cmp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool string_bytes (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool string_length (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool string_index (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm)
...
static bool string_count (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm)
...
static bool string_repeat (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool string_number (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
    gravity_value_t value = convert_string2number(VALUE_AS_STRING(GET_VALUE(0)), number_format_any);
    RETURN_VALUE(value, rindex);
}

static bool string_upper (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    gravity_string_t *main_str = VALUE_AS_STRING(GET_VALUE(0));
...
static bool string_lower (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    gravity_string_t *main_str = VALUE_AS_STRING(GET_VALUE(0));
...
static bool string_loadat (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool string_storeat (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs, rindex)
...
static bool string_split (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    // sanity check
...
static bool string_find_replace (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    // sanity check
...
static bool string_loop (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    if (nargs < 2) RETURN_ERROR("Incorrect number of arguments.");
    if (!VALUE_ISA_CLOSURE(GET_VALUE(1))) RETURN_ERROR("Argument must be a Closure.");
...
static bool string_iterator (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_string_t *string = VALUE_AS_STRING(GET_VALUE(0));
...
static bool string_iterator_next (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_string_t *string = VALUE_AS_STRING(GET_VALUE(0));
...
static bool string_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool string_trim (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool string_raw (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
    gravity_string_t *string = VALUE_AS_STRING(GET_VALUE(0));
...
static bool string_toclass (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, nargs)
...
static bool fiber_create (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool fiber_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return fiber_run(vm, args, nargs, rindex, false);
}

static bool fiber_try (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return fiber_run(vm, args, nargs, rindex, true);
}

static bool fiber_yield (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool fiber_yield_time (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(args, nargs, rindex)
...
static bool fiber_done (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool fiber_status (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool fiber_elapsed_time (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(nargs)
...
static bool fiber_abort (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool operator_null_add (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,nargs)
    // NULL + v2 = v2
    RETURN_VALUE(args[1], rindex);
}

static bool operator_null_sub (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    // NULL - v2 should be computed as -v2 in my opinion (since NULL is interpreted as zero)
    args[0] = VALUE_FROM_INT(0);
    return operator_int_sub(vm, args, nargs, rindex, NULL);
}

static bool operator_null_div (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,args,nargs)
    // NULL / v2 = 0
    RETURN_VALUE(VALUE_FROM_INT(0), rindex);
}

static bool operator_null_mul (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,args,nargs)
    // NULL * v2 = 0
    RETURN_VALUE(VALUE_FROM_INT(0), rindex);
}

static bool operator_null_rem (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,args,nargs)
    // NULL % v2 = 0
    RETURN_VALUE(VALUE_FROM_INT(0), rindex);
}

static bool operator_null_and (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,args,nargs)
    RETURN_VALUE(VALUE_FROM_BOOL(0), rindex);
}

static bool operator_null_or (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,nargs)
...
// unary operators
static bool operator_null_neg (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,args,nargs)
    RETURN_VALUE(VALUE_FROM_BOOL(0), rindex);
}

static bool operator_null_not (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,args,nargs)
...
static bool operator_null_silent (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,args,nargs)
    gravity_value_t key = GET_VALUE(1);
    if (VALUE_ISA_STRING(key)) {
...
static bool operator_store_null_silent (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool operator_null_cmp (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm,nargs)
...
static bool null_exec (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_NULL, rindex);
}

static bool null_iterator (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused(vm, args, nargs)
    RETURN_VALUE(VALUE_FROM_FALSE, rindex);
}
...
static bool system_nanotime (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
...
static bool system_put (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return system_realprint(vm, args, nargs, rindex, false);
}

static bool system_print (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    return system_realprint(vm, args, nargs, rindex, true);
}

static bool system_get (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (args, nargs)
    gravity_value_t key = GET_VALUE(1);
...
static bool system_set (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (nargs, rindex)
    gravity_value_t key = GET_VALUE(1);
    gravity_value_t value = GET_VALUE(2);
...
static bool system_exit (gravity_vm *vm, gravity_value_t *args, uint16_t nargs, uint32_t rindex, void * nu) {
    #pragma unused (vm, nargs, rindex)
