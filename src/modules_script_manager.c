...
#include "script_native__matrix.h"
...
#include "script_native__audio.h"
...
static void add_all_refs(topazScriptManager_t * s, topazScript_t * script, int permissions) {
    ...
    add_refs__material_api(script, s);
