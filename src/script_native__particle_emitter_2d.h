...
static void add_refs__particle_emitter_2d_api(topazScript_t * script, topazScriptManager_t * context) {
    TS_MAP_NATIVE_FN("topaz_particle_emitter_2d__create", particle_emitter_2d_api__create);

    // member functions
    TS_MAP_NATIVE_FN("topaz_particle_emitter_2d__set_particle", particle_emitter_2d_api__set_particle);
    TS_MAP_NATIVE_FN("topaz_particle_emitter_2d__set_independent", particle_emitter_2d_api__set_independent);
    TS_MAP_NATIVE_FN("topaz_particle_emitter_2d__emit", particle_emitter_2d_api__emit);
