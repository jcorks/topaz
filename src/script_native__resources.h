...
static void add_refs__resources_api(topazScript_t * script, topazScriptManager_t * context) {
    ...
    TS_MAP_NATIVE_FN("topaz_resources__fetch_asset", resources_api__fetch_asset, 2);
    ...
    TS_MAP_NATIVE_FN("topaz_resources__load_asset_data", resources_api__load_asset_data, 3);
    TS_MAP_NATIVE_FN("topaz_resources__load_asset_base64", resources_api__load_asset_base64, 3);
